...
import vertical_spawn_control_client.ui.JTreeNodeTextArea;
import vertical_spawn_control_client.ui.JTreeNodeTextField;

public class TreeNodeLongStringLeaf extends TreeLeafBase implements TreeNodeValueHolder {
	
	private String value;
	JTextArea inputField = new JTreeNodeTextArea(this);

	public TreeNodeLongStringLeaf(TreeNode parentIn, String nameIn, String valueIn) {
	...
	public static Function<TreeNode, TreeNodeLongStringLeaf> getSupplier(String name, String defaultValue) {
		return new Function<TreeNode, TreeNodeLongStringLeaf>() {
			@Override
			public TreeNodeLongStringLeaf apply(TreeNode t) {
				return new TreeNodeLongStringLeaf(t, name, defaultValue);
			}
		};
	}
